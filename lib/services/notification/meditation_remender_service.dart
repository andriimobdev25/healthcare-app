...
class MedicationService {
  ...
  static Future<void> _scheduleNotification(
    ...
    switch (frequency.toLowerCase()) {
      case "daily":
        await _scheduleDaily(medicationName, dosage, scheduleTime, notificationDetails);
        break;
      case "twice daily":
        await _scheduleDaily(medicationName, dosage, scheduleTime, notificationDetails);
        break;
      case "three times daily":
        ...
        break;
      case "weekly":
        await _scheduleWeekly(medicationName, dosage, scheduleTime, notificationDetails);
        break;
      default:
